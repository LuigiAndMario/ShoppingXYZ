...
%
% 1st. author
	\alignauthor \normalsize{IVANOV Danil, SANSONETTI Luigi, HÄNER Dominik, DRESCHER Lukas}\\
		...
		three@student.ethz.ch,
		four@student.ethz.ch}}
}
...
\maketitle
	...
	\begin{abstract}
		...
		in a shared living accommodation. The main idea is to use the concepts of distributed
		computing to maintain an updated state of various lists across all devices 
		in a cluster.
	...
	\section{System Overview}
		...
		\begin{description}
			...
			\item[Project design:] The user interface will be similar to the following:
